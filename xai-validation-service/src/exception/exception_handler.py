...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(ValidationSvcException)
    async def validation_svc_handler(_request: Request, exc: ValidationSvcException) -> JSONResponse:
        logger.error("ValidationSvcException | code: %s | message: %s", exc.error_code, exc.message)
