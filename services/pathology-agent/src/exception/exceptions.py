class PathologyBaseException(Exception):
    """Base exception for the Pathology Agent service."""
...
class LLMInvocationException(PathologyBaseException):
    """Raised when the LLM call fails."""
    def __init__(self, message: str):
        super().__init__(error_code="LLM_INVOCATION_ERROR", message=message)


class LLMResponseParseException(PathologyBaseException):
