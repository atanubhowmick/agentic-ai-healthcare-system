...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(NeurologySvcException)
    async def neurology_exception_handler(_request: Request, exc: NeurologySvcException) -> JSONResponse:
        logger.error("NeurologySvcException caught | code: %s | message: %s", exc.error_code, exc.message)
