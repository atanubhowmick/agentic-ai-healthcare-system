class NeurologyBaseException(Exception):
    """Base exception for the Neurology Agent service."""
...
class LLMInvocationException(NeurologyBaseException):
    """Raised when the LLM call fails."""
    def __init__(self, message: str):
        super().__init__(error_code="LLM_INVOCATION_ERROR", message=message)


class LLMResponseParseException(NeurologyBaseException):
