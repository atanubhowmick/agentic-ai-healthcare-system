...
def _build_query(request: NeurologyRequest) -> str:
...
def _parse_diagnosis(patient_id: str, content: str) -> NeurologyResult:
...
async def diagnose(request: NeurologyRequest) -> NeurologyResponse:
    ...
    return NeurologyResponse(agent=AGENT_NAME, agent_id=AGENT_ID, diagnosis=diagnosis)
