...
```json
{
  ...
  "payload": {
    ...
    "option_1_decision_accuracy": { "approval_accuracy": 0.27, "..." },
    "option_2_safety_net_effectiveness": { "sensitivity": 1.0, "..." },
    "option_4_rule_engine_coverage": { "rule_coverage_rate": 0.20, "..." },
    "option_6_over_rejection_rate": { "over_rejection_rate": 0.73, "..." },
