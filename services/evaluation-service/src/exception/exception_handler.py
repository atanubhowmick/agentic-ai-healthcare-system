...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(EvaluationSvcException)
    async def evaluation_exception_handler(_request: Request, exc: EvaluationSvcException) -> JSONResponse:
        logger.error("EvaluationSvcException | code: %s | message: %s", exc.error_code, exc.message)
