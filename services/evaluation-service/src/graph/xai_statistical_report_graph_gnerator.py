...
from core.config import XAI_STATISTICAL_REPORT_PLOTS_DIR
...
def generate_xai_statistical_report_graphs(output_dir: str = XAI_STATISTICAL_REPORT_PLOTS_DIR) -> None:
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output-dir",
        default=XAI_STATISTICAL_REPORT_PLOTS_DIR,
        help=f"Root directory for output (default: {XAI_STATISTICAL_REPORT_PLOTS_DIR}, "
             "override with XAI_STATISTICAL_REPORT_PLOTS_DIR env var)",
    )
