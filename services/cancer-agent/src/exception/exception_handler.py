...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(CancerSvcException)
    async def cancer_exception_handler(_request: Request, exc: CancerSvcException) -> JSONResponse:
        logger.error("CancerSvcException caught | code: %s | message: %s", exc.error_code, exc.message)
