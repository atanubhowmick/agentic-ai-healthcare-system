...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(TreatmentSvcException)
    async def treatment_svc_handler(_request: Request, exc: TreatmentSvcException) -> JSONResponse:
        logger.error("TreatmentSvcException | code: %s | message: %s", exc.error_code, exc.message)
