...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(CardiologySvcException)
    async def cardiology_exception_handler(_request: Request, exc: CardiologySvcException) -> JSONResponse:
        logger.error("CardiologySvcException caught | code: %s | message: %s", exc.error_code, exc.message)
